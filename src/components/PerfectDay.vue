<template>
	<div class="container">
		...
		<div class="firm" v-if="isPefectDay">
			<iframe width="100%" height="700px" src="https://goplayer.me/embed?url=https://vip.opstream17.com/20240302/1835_f7d8e89e/index.m3u8" title="Perfect Day"></iframe>
		</div>
	</div>
</template>
...
button:is(:hover, :focus-visible) .container1 {
	width: 100%;
}
...
export default {
    ...
    methods: {
        hoverPerfect() {
            this.isPefectDay = !this.isPefectDay;
        }
    }
};
